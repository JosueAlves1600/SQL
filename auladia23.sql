...
update TORNEIOS
set nome = 'Valorant World Challenge 2025'
where nome = 'Desafio Global 2025'

update TORNEIOS
set premiacao_total = premiacao_total * 1.25
where premiacao_total = 50000

delete from AVALIACOES
where nota = 3

delete from TIMES
where nome = 'Storm Breakers'

delete from JOGOS
where nome = 'Fortnite'

delete from PARTICIPACOES
where torneio = 'Valorant World Challenge 2025'

delete from JOGADORES
where nome = 'Lucas Almeida'
delete from AVALIACOES
where jogador = 'Lucas Almeida' and nota = 5
